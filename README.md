...
|---|---|---|---|---|---|---|
| 36 | Vivek Rao | vivek.rao@zoho.com | GBH34WW2KIJZ6IYPV6A3VO4Q3QSESGB3KFEM65KY3YTDYYDQYGNO5GXY | "Bahut achha system hai! Agents apne aap payment kar rahe hain, koi manual intervention nahi chahiye. Budget feature ne hamare organization mein bahut control diya hai." | Added a daily budget usage progress bar to each agent card. | [0ec7628](https://github.com/arihantgh/constella/commit/0ec762899b70c8eae98d3f2343c39bec19a8e4f3) |
| 38 | Aditi Dubey | aditi_dubey@rediffmail.com | GBNZSQCFCKCDF3O4GY3DJHXXOZ3OJPJBRVABVWO43KOP35OL2SHHZU7A | (Rated 5 — no written feedback) | Added a user satisfaction widget that surfaces the average feedback rating. | [adef946](https://github.com/arihantgh/constella/commit/adef94634953844774c73f77a01915ea500afc76) |
...
| 9 | Esha Tiwari | esha.tiwari@icloud.com | GBEGMBPZD4YC73WKQDVP4P5ECDMTA5NT5LEWOYKALPRY4CRSETWYEM26 | "Setup was surprisingly easy. Connected Freighter, registered agents, set budgets — all within 10 minutes. The documentation is clear and helpful." | Added an interactive getting-started checklist for new users. | [efa84cc](https://github.com/arihantgh/constella/commit/efa84cc21895ca06f5083d10daf30c30565502d6) |
| 59 | Chandan Kamath | chandan_kamath@outlook.com | GCOEYTKDZOPTDYYNW5ETPPWGKNWVBDX2AFD5PGUCMMFVNKKHG4SLWWNP | (Rated 4 — no written feedback) | Added a feedback prompt CTA encouraging detailed responses. | [bb73ac1](https://github.com/arihantgh/constella/commit/bb73ac12e68ba187bc3d2e082362ea24899916c5) |
...
| 27 | Deepika Sharma | deepikasharma39@rediffmail.com | GBT2TCJ4F6T2XDWBBFYTWKAV72UCNHVRPL5SIDQ2BDZUKHSRJYMPHOQY | "This is exactly what the decentralized agent economy needed. The fact that budget policies are enforced on-chain and not just in UI is a huge trust factor." | Added an on-chain verification badge for the budget policy contract. | [94109f0](https://github.com/arihantgh/constella/commit/94109f019cf0321a716ae8dae4a4b19af12a0145) |
...
| 55 | Rahul Agarwal | rahul_agarwal@icloud.com | GARGW2ASP4LSRRZ6RVMWXWRM5ZK3CVA2CCHVW5AAVEEYX4IIHC5KLXUF | "The event relay system works well. We set it up on Cloudflare Workers and the WebSocket connection stays stable even with frequent disconnections." | Show the relay's last-event timestamp in the live payment feed. | [6ab2c5e](https://github.com/arihantgh/constella/commit/6ab2c5e0dfcc15539a8c96454e057e0bc97f4f2a) |
| 42 | Lalit Saxena | lalit_saxena@proton.me | GD67IVUIS5FW22JEVH7MJELVJDO7HVW7FSPOPPTSKFKEVVHRN4L27DF7 | "Mujhe yeh product bahut pasand aaya. Particularly the way agents can autonomously pay each other without human approval every time. Budget limits ensure no one overspends." | Added an autonomous payment guardrails explainer card. | [341e6bf](https://github.com/arihantgh/constella/commit/341e6bfaf6c83a61e34a6b1f58f3acfb3178fe22) |
| 33 | Uday Banerjee | udaybanerjee@rediffmail.com | GDY4DNS3ZFKJB3VYDFDHVMEPMBLZFXORDQPCLC763MWMIW7RYNWEWMDO | "Solid architecture. The separation between Agent Registry, Budget Policy, and Payment contracts makes sense. Easy to extend for our use case." | Added a contract architecture footer explaining the registry → policy → payment flow. | [99e381e](https://github.com/arihantgh/constella/commit/99e381e8025bff219c951d4b93718a2597c4ef31) |
...
| 51 | Isha Nair | ishanair93@icloud.com | GDOACY6W7UN3R4YNKKXIKX7UPPRRKD236HPRBXZM373USCZYPWJ4PJVB | "Hamare startup ke liye yeh perfect hai. We have 15 micro-agents handling different tasks and they all pay each other automatically. Monthly reconciliation is now fully automated." | Added a monthly reconciliation CSV export from the live feed. | [51d9430](https://github.com/arihantgh/constella/commit/51d9430c1bf3a53f1f583d835db2e77a6def69fc) |
...
| 46 | Anjali Pandey | anjali_pandey@yahoo.in | GDCMUPRA4V6EU2WQJ7C2HOXYC4SPE7U6FW2ISFHEVDVZPUHQIJEOGZLE | "Team has done fantastic work. The inter-contract communication pattern is a reference architecture for anyone building on Soroban. Budget policy as a separate contract is a smart design choice." | Added on-chain contract explorer links in the footer. | [6da0616](https://github.com/arihantgh/constella/commit/6da0616b0fd0cc4cec47ce5c230b3d8d31ed5a21) |
...
| 5 | Bhavna Deshmukh | bhavnadeshmukh5@zoho.com | GCPCIF6VZCWEO7BRM2TTDDU42TOVADANDYAV6AQ7HFJ256FIYKQY5NAG | "Very good for a v1 product. The mobile responsive design is appreciated — I can monitor my agents from my phone. Dark mode would be a nice addition." | Added a dark mode toggle with system preference support. | [31c6df7](https://github.com/arihantgh/constella/commit/31c6df7adefb8d5974e6c48cecfe4c897887ccc8) |
